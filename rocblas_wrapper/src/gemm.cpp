...
template __host__ void gemm<true, true>(half*        C,
                                        half*        A,
                                        half*        B,
                                        size_t       M,
                                        size_t       N,
...
template __host__ void gemm<true, false>(half*        C,
                                         half*        A,
                                         half*        B,
                                         size_t       M,
                                         size_t       N,
...
template __host__ void gemm<false, true>(half*        C,
                                         half*        A,
                                         half*        B,
                                         size_t       M,
                                         size_t       N,
...
template __host__ void gemm<false, false>(half*        C,
                                          half*        A,
                                          half*        B,
                                          size_t       M,
                                          size_t       N,
